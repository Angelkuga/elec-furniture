var RadarChart = {
        ...
        if(cfg.axisLine || cfg.axisText) {
          ...
          if(cfg.axisText) {
            ...
            axis.select('image')
              ...
              .attr('y', function(d, i){ 
                 var yOff = d.yOffset-72;
                if(i == 2 || i==3)
                  yOff = d.yOffset-8;
                return yOff+ (cfg.h/2-radius2)+getVerticalPosition(i, radius2, cfg.factorLegend); })
              .attr('xlink:href',function(d,i) { return cfg.baseImgPath+(i+1)+'.png'});
          }
 ...
 RadarChart.draw(".chart-container", data);
  ...
  var spaceW =  $(".chart-container").width();
     var spaceH = spaceW;
     $("svg").attr("width",spaceW);
     $("svg").attr("height",spaceH);
